...
This document describes the columns in `data/tabular/homer3_betas_plus_combined_sfv_data_inner_join.csv`.
...
These columns come from `data/tabular/engagement_data_processed.csv`, derived from the long-format table
...
These columns come from `data/tabular/socio_demographic_data_processed.csv`, generated by `process_sociodemographic.py`
...
These columns come from `data/tabular/recall_assessment_score_diffs.csv`, generated by `demographic/process_recall_assessment.py`
